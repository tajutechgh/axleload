...
<div class="card">
    <div class="card-body">
        ...
        <div class="text-center">
            ...
            @endforeach
            <h6>Transaction Fine Receipt(Copy)</h6>
        </div><br>
        <section class="content-header">
            <h4>
            Receipt <small>#{{$fine->invoice_number}}</small>
            </h4>
        </section>
        ...
        <section class="invoice">
            ...
            <div class="row no-print">
                <div class="col-lg-3">
                    <a href="{{ route('fines.enquiry') }}" class="btn btn-primary fa fa-arrow-left" title="Click here to go back"> Go Back</a>
