                  	...
                  	<form action="{{ route('permission.store') }}" method="post">
	                    ...
	                    <div class="modal-content animated flipInX">
                          ...
                          <div class="form-group">
                            <label for="permission name" style="font-size: 15px;">Permission Name: <span class="text-danger">*</span></label>
		            ...
		            <table id="default-datatable" class="table table-bordered">
                        ...
                        @foreach ($permissions as $permission)
                          <tr>
                              ...
                              <td>
                                  {{-- edit button --}}
                                  <button type="button" class="btn btn-success waves-effect waves-light fa fa-edit" data-toggle="modal" data-target="#id{{$permission->id}}"></button>

                                  <div class="modal fade" id="id{{$permission->id}}">
                                    <div class="modal-dialog">
                                      <form action="{{ route('permission.update',$permission->id) }}" method="post">
                                          ...
                                          <div class="modal-content animated flipInX">
                                            ...
                                            <div class="modal-body">
                                              <div class="form-group">
                                                <label for="permission name" style="font-size: 15px;">Permission Name: 
                                  ...
                                  {{-- delete button --}}
                                  <form method="post" id="delete-form-{{$permission->id}}"
