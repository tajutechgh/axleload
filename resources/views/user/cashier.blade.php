        ...
        <div class="card gradient-scooter">
            <div class="card-body">
                <div class="media align-items-center">
                  <div class="w-icon"><i class="fa fa-truck text-white"></i></div>
                  <div class="media-body ml-3 border-left-xs border-white-2">
                    <h4 class="mb-0 ml-3 text-white">{{$todayTransactions}}</h4>
                    <p class="mb-0 ml-3 extra-small-font text-white">Today Total Vehicles Weighed</p>
                  </div>
                </div>
             </div>
        </div>
        ...
        <div class="card gradient-bloody">
            <div class="card-body">
                <div class="media align-items-center">
                    <div class="w-icon"><i class="fa fa-truck text-white"></i></div>
                    <div class="media-body ml-3 border-left-xs border-white-2">
                       <h4 class="mb-0 ml-3 text-white">{{$todayOverloadVehicles}}</h4>
                       <p class="mb-0 ml-3 extra-small-font text-white">Today Total Overloaded Vehicles</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card gradient-quepal">
            <div class="card-body">
                <div class="media align-items-center">
                    ...
                    <div class="media-body ml-3 border-left-xs border-white-2">
                        @foreach ($todayFineAmounts as $element)
                            <?php 
                            $total = $element->fine_amount + @setting('overheightfine') + @setting('avoidedweighingfine');
                            ?>
                        @endforeach
                        <h4 class="mb-0 ml-3 text-white">GH₵ {{$total}}</h4>
                        <p class="mb-0 ml-3 extra-small-font text-white">Today Total Amount Fines</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card gradient-blooker">
            <div class="card-body">
                <div class="media align-items-center">
                    <div class="w-icon"><i class="fa fa-money text-white"></i></div>
                    <div class="media-body ml-3 border-left-xs border-white-2">
                      <h4 class="mb-0 ml-3 text-white">GH₵ {{$todayFinesCollected}}</h4>
                      <p class="mb-0 ml-3 extra-small-font text-white">Today Total Amount Collected</p>
                    </div>
                </div>
            </div>
        </div>
