...
<div class="row pt-2 pb-2">
    <div class="col-sm-9">
		<h4 class="page-title">Manage Regions</h4>
    </div>
</div><!-- End Breadcrumb-->
	                    ...
	                    <div class="modal-content animated flipInX">
	                      ...
	                      <div class="modal-body">
	                        <div class="form-group">
	                        	<label for="commodity name" style="font-size: 15px;">Region Name: <span class="text-danger">*</span></label>
	                        	<input type="text" class="form-control" name="region_name" required="" placeholder="Enter region name">
	                        </div>
	                      </div>
		                ...
		                <tbody>
                            @foreach ($regions as $region)
                                <tr>
                                    ...
                                    <td>
                                        {{-- edit button --}}
                                        <button type="button" class="btn btn-success waves-effect waves-light fa fa-edit" data-toggle="modal" data-target="#id{{$region->id}}"></button>

                                        <div class="modal fade" id="id{{$region->id}}">
                                          <div class="modal-dialog">
                                            <form action="{{ route('region.update',$region->id) }}" method="post">
                                                ...
                                                <div class="modal-content animated flipInX">
                                                  ...
                                                  <div class="modal-body">
                                                    <div class="form-group">
                                                        <label for="commodity name" style="font-size: 15px;">Region Name: 
                                                          <span class="text-danger">*</span></label>
                                                        <input type="text" class="form-control" name="region_name" required="" value="{{$region->region_name}}">
                                                    </div>
                                                  </div>
                                                  <div class="modal-footer">
                                                    <button type="button" class="btn btn-danger" data-dismiss="modal"><i class="fa fa-times"></i> Close
                                        ...
                                        {{-- delete button --}}
                                        <form method="post" id="delete-form-{{$region->id}}"
                                            action="{{route('region.destroy',$region->id)}}" style="display: none;">
